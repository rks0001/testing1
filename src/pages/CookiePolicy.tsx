  ...
  return (
    <div>
      <div className="maindiv">
        <div className="headdtext">Cookie Policy for aid24x7.in</div>
        This is the Cookie Policy for aid24x7.in, accessible from
        https://www.aid24x7.in
        <br />
        <div className="headdtext">What Are Cookies</div>
        ...
        sites functionality.
        <br />
        <div className="headdtext">How We Use Cookies</div>
        ...
        <br />
        <div className="headdtext">Disabling Cookies</div>
        ...
        <br />
        <div className="headdtext">The Cookies We Set</div>
        ...
        <br />
        <li>Site preferences cookies</li> In order to provide you with a great
        ...
        preferences.
        <br />
        <div className="headdtext">Third Party Cookies </div>
        ...
        <ul>
          ...
          <li>
            ...
            &lbrace;List the social networks whose features you have integrated
            with your site?:12&rbrace;, will set cookies through our site which
        ...
        <div className="headdtext">More Information</div>
        ...
        does interact with one of the features you use on our site. <br />
        For more general information on cookies, please read the Cookies Policy
        article.
        <br /> However if you are still looking for more information then you
        can contact us through one of our preferred contact methods:
        <br />
        <li>Email: aid24x7pharma@gmail.com </li>
        <li>Phone: 9957481738</li>
      </div>
    </div>
  );
};
