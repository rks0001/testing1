  ...
  return (
    <div>
      <div className="maindiv">
        <div className="headdtext">ACCEPTABLE USE POLICY</div>
        Last updated December 04, 2022 <br />
        This Acceptable Use Policy (&#39;Policy&#39;) is part of our Terms and
        Conditions (&#39;Legal Terms&#39;) and should therefore be read
        alongside our main Legal Terms: __________. If you do not agree with
        ...
        <br />
        Please carefully review this Policy which applies to any and all: <br />
        (a) uses of our Services (as defined in &#39;Legal Terms&#39;) and{" "}
        <br />
        (b) forms, materials, consent tools, comments, post, and all other
        content available on the Services (&#39;Content&#39;) <br />
        <div className="headdtext">WHO WE ARE</div>
        We are AID 24x7 (&#39;Company&#39;,&#39;we&#39;, &#39;us&#39;, or
        &#39;our&#39;) a company registered in India at GOLAI NO 1, DIGBOI,
        ASSAM 786171. We operate the website https://www.aid24x7.in (the
        &#39;Site&#39;), the mobile application AID 24x7 (the &#39;App&#39;), as
        well as any other related products and services that refer or link to
        this Policy (collectively, the &#39;Services&#39; ).
        <br />
        <div className="headdtext">USE OF THE SERVICES</div>
        When you use the Services you warrant that you will comply with this
        Policy and with all applicable laws. <br />
        ...
        <ul>
          ...
          <li>
            ...
            Policy, without the prior written consent of AID 24x7, which consent
            AID 24x7 may grant or refuse in its sole and absolute discretion.
          </li>
          <li>
        ...
        <div className="headdtext">CONSEQUENCES OF BREACHING THIS POLICY </div>
        ...
        way of example:
        <br /> We may, in some cases, give you a warning, however, if your
        breach is serious or if you continue to breach our Legal Terms and this
        Policy, we have the right to suspend terminate your access to and use of
        ...
        public safety.
        <br />  We exclude our liability for all action we may take in response
