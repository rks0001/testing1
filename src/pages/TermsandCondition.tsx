  ...
  return (
    <div>
      <div className="maindiv">
        <div className="headdtext"> Terms and Conditions</div>
        Welcome to aid24x7.in!
        <br />
        These terms and conditions outline the rules and regulations for the use
        of AID 24x7&#39;s Website, located at https://aid24x7.in.
        <br />
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use aid24x7.in if you do not agree to
        ...
        <br />
        <div className="headdtext">Cookies</div>
        We employ the use of cookies. By accessing aid24x7.in, you agreed to use
        cookies in agreement with the AID 24x7&#39;s Privacy Policy.
        <br />
        ...
        cookies.
        <br />
        <div className="headdtext">License</div>
        Unless otherwise stated, AID 24x7 and/or its licensors own the
        intellectual property rights for all material on aid24x7.in. All
        intellectual property rights are reserved. You may access this from
        aid24x7.in for your own personal use subjected to restrictions set in
        these terms and conditions.
        <br />
        You must not:
        <ul>
          <li>Republish material from aid24x7.in</li>
          <li>Sell, rent or sub-license material from aid24x7.in</li>
          <li>Reproduce, duplicate or copy material from aid24x7.in</li>
          <li>Redistribute content from aid24x7.in</li>
        </ul>
        <br />
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. AID
        24x7 does not filter, edit, publish or review
        <br />
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of AID 24x7,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, AID 24x7
        ...
        <br />
        AID 24x7 reserves the right to monitor all Comments and to remove any
        ...
        <br />
        You hereby grant AID 24x7 a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
        <br />
        <div className="headdtext">Hyperlinking to our Content</div>
        ...
        the hyperlink compensates the absence of AID 24x7; and (d) the link is
        ...
        e-mail to AID 24x7. Please include your name, your organization name,
        ...
        <br />
        No use of AID 24x7&#39;s logo or other artwork will be allowed for
        linking absent a trademark license agreement.
        <div className="headdtext">iFrames</div>
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website. <br />
        <div className="headdtext">Content Liability</div>
        ...
        <div className="headdtext">Your Privacy</div>
        Please read Privacy Policy
        <div className="headdtext">Reservation of Rights</div>
        ...
        <div className="headdtext">Removal of links from our website</div>
        ...
        <div className="headdtext">Disclaimer</div>
